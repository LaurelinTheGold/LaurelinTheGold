...
`C++` `CUDA` `cuDNN` `Python` `PyTorch` `GPU` `Machine Learning` `Deep Learning` <br/>
...
### [GPU Wavefront Path Tracer](https://github.com/LaurelinTheGold/Project3-CUDA-Path-Tracer): ###
...
`C++` `CUDA` `GPU` `Rendering` `Computer Graphics` <br/>
<img src="https://github.com/LaurelinTheGold/Project3-CUDA-Path-Tracer/raw/main/finalRenders/ebon_final.png" width="480" />

### [Fill In The Gaps](https://github.com/LaurelinTheGold/College_Public/blob/main/TestProject.pdf): ###
Object Localization using Event Based Cameras <br/>
`PyTorch` `Python` `Computer Vision` `Deep Learning` `Machine Learning` <br/>
...
`C++` `Vulkan` `GPU` `Rendering` `Computer Graphics` <br/>
...
### [Mini-Minecraft](https://github.com/LaurelinTheGold/College_Public/blob/main/stingy.md): ###
...
### [JCompiler](https://github.com/LaurelinTheGold/College_Public/blob/main/stingy.md): ###
A compiler for the J language[^JC] that targets LC4[^LC4] assembly <br/>
`C` `assembly` `Compilers` <br/>
...
### [CPU Path Tracer](https://github.com/LaurelinTheGold/RTIOW_rust): ###
CPU Path Tracer following the Ray Tracing in One Weekend [RTIOW](https://raytracing.github.io/books/RayTracingInOneWeekend.html) tutorial <br/>
`Rust` `Rendering` `Computer Graphics` <br/>
<img src="https://raw.githubusercontent.com/LaurelinTheGold/RTIOW_rust/main/images/image_balls_1920_1200.png" width="480" />

### [Block Picking Competition](https://github.com/LaurelinTheGold/College_Public/blob/main/Meam520_final_project.pdf): ###
Franka Emika Panda Robot Arm Picking and Placing Blocks <br/>
`ROS` `Python` `Robotics` `Perception` `Plannning` <br/>
<img src="./demo_imgs/dynamic_blocks.jpg" width="240" />

### [Data Unlimited Compile for FPGAs](https://github.com/LaurelinTheGold/College_Public/blob/main/srdesign_poster_fall_rev8.pdf): ###
Easier FPGA prototyping with more RAM and faster compile times <br/>
`FPGA` `RISC-V` `HLS C` `Hardware Acceleration` <br/>
<img src="./demo_imgs/sen_des.png" width="480" />

### [SRAM Design](https://github.com/LaurelinTheGold/College_Public/blob/main/ese370proj3_final.pdf): ###
16 Nibble SRAM and driver circuitry <br/>
`GNU Electric` `Ngspice` `Digital Design` `Computer Architecture` `Computer Hardware` <br/>
<img src="./demo_imgs/full_sram2.png" width="480" />

### [Fuzzy Dark Matter](https://github.com/LaurelinTheGold/fuzzyDM): ###
My research code used in [this paper](https://arxiv.org/abs/2101.07177) <br/>
`Pyton` `Matplotlib` `Numpy` `Astrophysics` `Cosmology` <br/>

### [Superscalar Pipelined LC4 CPU](https://github.com/LaurelinTheGold/College_Public/blob/main/stingy.md): ###
Dual-Issue, In-Order, Pipelined LC4[^LC4] CPU <br/>
`Verilog` `Computer Architecture` `Computer Hardware` <br/>

### [PennOS](https://github.com/LaurelinTheGold/College_Public/blob/main/stingy.md): ###
Unix-like OS with kernel and filesystem <br/>
`C` `Operating Systems` `Computer Systems` `File System`

### [PennShell](https://github.com/LaurelinTheGold/College_Public/blob/main/stingy.md): ###
Shell with piping and built-ins <br/>
`C` `Operating Systems` `Computer Systems`

### [Lu Syntax Checker](https://github.com/LaurelinTheGold/College_Public/blob/main/stingy.md):  ###
Adding a type system, syntax checking, and language server to a subset of Lua <br/>
`Haskell` `Monads` `Monad Transformers` <br/>
